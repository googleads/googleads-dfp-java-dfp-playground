...
import com.google.api.ads.dfp.jaxws.v201306.CompanyServiceInterface;
import com.google.api.ads.dfp.jaxws.v201306.Statement;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch company entities.
 *
 * @author Jeff Sham
 */
public class CompanyFetcher extends AbstractFetcher {

  @Inject
  public CompanyFetcher(DfpServices dfpServices, Channels channels) {
