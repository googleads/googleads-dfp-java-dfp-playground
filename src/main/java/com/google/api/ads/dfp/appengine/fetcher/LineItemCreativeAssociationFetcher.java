...
import com.google.api.ads.dfp.jaxws.v201306.LineItemCreativeAssociationServiceInterface;
import com.google.api.ads.dfp.jaxws.v201306.Statement;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch line item creative association entities.
 *
 * @author Jeff Sham
 */
public class LineItemCreativeAssociationFetcher extends AbstractFetcher {

  @Inject
  public LineItemCreativeAssociationFetcher(
