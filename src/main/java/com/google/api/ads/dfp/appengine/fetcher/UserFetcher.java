...
import com.google.api.ads.dfp.jaxws.v201306.UserServiceInterface;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch user entities.
 *
 * @author Jeff Sham
 */
public class UserFetcher extends AbstractFetcher {

  @Inject
  public UserFetcher(DfpServices dfpServices, Channels channels) {
  ...
  public void fetch(String filterText, String channelKey, String tag, String requestId,
      DfpSession session) {
    // Create the service.
    final UserServiceInterface userService = dfpServices.get(session, UserServiceInterface.class);
    ...
    PageFetcher pageFetcher = new PageFetcher() {
      ...
      public Object getByStatement(Statement statement) throws ApiException_Exception {
        return userService.getUsersByStatement(statement);
      }
    };
    // Fetch the objects.
