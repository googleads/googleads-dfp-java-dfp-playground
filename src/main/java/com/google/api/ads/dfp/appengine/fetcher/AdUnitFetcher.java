...
import com.google.api.ads.dfp.jaxws.v201306.InventoryServiceInterface;
import com.google.api.ads.dfp.jaxws.v201306.Statement;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch ad unit entities.
 *
 * @author Jeff Sham
 */
public class AdUnitFetcher extends AbstractFetcher {

  @Inject
  public AdUnitFetcher(DfpServices dfpServices, Channels channels) {
