...
/**
 * A class to make API requests to fetch line item entities.
 *
 * @author Jeff Sham
 */
public class LineItemFetcher extends AbstractFetcher {

  @Inject
  public LineItemFetcher(DfpServices dfpServices, Channels channels) {
