...
/**
 * A class to make API requests to fetch order entities.
 *
 * @author Jeff Sham
 */
public class OrderFetcher extends AbstractFetcher {

  @Inject
  public OrderFetcher(DfpServices dfpServices, Channels channels) {
