...
import com.google.api.ads.dfp.jaxws.v201403.CustomTargetingServiceInterface;
import com.google.api.ads.dfp.jaxws.v201403.Statement;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch custom targeting keys.
 *
 * @author Jeff Sham
 */
public class CustomTargetingKeyFetcher extends AbstractFetcher {

  @Inject
  public CustomTargetingKeyFetcher(DfpServices dfpServices, Channels channels) {
