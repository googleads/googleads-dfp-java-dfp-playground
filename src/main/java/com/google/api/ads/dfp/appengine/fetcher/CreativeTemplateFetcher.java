...
import com.google.api.ads.dfp.jaxws.v201403.CreativeTemplateServiceInterface;
import com.google.api.ads.dfp.jaxws.v201403.Statement;
import com.google.api.ads.dfp.lib.client.DfpSession;
import com.google.inject.Inject;

/**
 * A class to make API requests to fetch creative template entities.
 *
 * @author Jeff Sham
 */
public class CreativeTemplateFetcher extends AbstractFetcher {

  @Inject
  public CreativeTemplateFetcher(DfpServices dfpServices, Channels channels) {
